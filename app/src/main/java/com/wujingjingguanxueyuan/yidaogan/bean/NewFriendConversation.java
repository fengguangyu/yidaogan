...
import com.wujingjingguanxueyuan.yidaogan.application.Config;
...
//import com.ego.im4bmob.ui.NewFriendActivity;
...
public class NewFriendConversation extends Conversation{
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(DemoApplication.INSTANCE()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(DemoApplication.INSTANCE()).updateBatchStatus();
    }
